                ...
                <div class="col-md-4">
                    <div class="panel rounded shadow">
                        <div class="panel-heading">
                            <div class="pull-left">
                                <h3 class="panel-title">Create Medal</h3>
                            </div>
                            ...
                            <form id="categories_form" class="form-horizontal">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea  class="form-control rounded" name="text" style="height: 100px;"></textarea>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label class="control-label">Notification text</label>
                                        <textarea  class="form-control " name="notification_text" style="height: 100px;"></textarea>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label class="control-label">Number of views needed to get this medal</label>
                                        <input  class="form-control rounded" name="views" >
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label class="control-label">Reword</label>
                                        <input  class="form-control " name="reword">
                                    </div>
                                </div>
