...
<div id="wrapper">
    ...
    <div class="sign-wrapper">
        ...
        <form id="sign-in" class="form-horizontal animated zoomIn shadow rounded" method="post">
            ...
            <div class="sign-body">
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                    <div class="input-group input-group-lg rounded">
                        <input type="password" class="form-control input-sm" placeholder="Confirm Password" name="password_confirmation">
                        <span class="input-group-addon"><i class="fa fa-lock"></i></span>
                    </div>
                </div><!-- /.form-group -->
                 <div class="form-group">
                    <div class="input-group input-group-lg rounded">
                        <input type="password" class="form-control input-sm" placeholder="Registration Key" name="registration_key">
                        <span class="input-group-addon"><i class="fa fa-lock"></i></span>
                    </div>
                </div><!-- /.form-group -->
            </div><!-- /.sign-body -->
        ...
        <!-- Content text -->
        <br/>
        <p class="text-muted text-center animated fadeinup">Need an account? <a href="<?=url()."/".CMS_NAME?>/login"> Login</a></p>
        <!--/ Content text -->
